...
- [ ] T001 创建 admin-api/app/services/skill_market/ 包骨架 + 子模块
...
- [ ] T005 实现监控聚合（量/成功率/耗时/异常，按版本）
- [ ] T006 实现异常下钻
- [ ] T007 US1 测试：指标口径 + 下钻

## Phase 4: User Story 2 (P2) — 效果打分 + 灰度回滚

- [ ] T008 实现效果分模型（0.5/0.3/0.2）
- [ ] T009 实现灰度调度 + 自动回滚（异常率>20%）
- [ ] T010 实现低质量标记（<0.4 持续7天，共用标记位）
- [ ] T011 US2 测试：打分 + 回滚 + 标记
